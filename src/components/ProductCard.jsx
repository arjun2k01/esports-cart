  ...
  return (
    <div className="bg-gray-800 rounded-lg shadow-xl overflow-hidden flex flex-col transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20 transform hover:-translate-y-1">
      ...
      <div className="p-6 flex-grow flex flex-col">
        <h3 className="text-xl font-bold text-white mb-2 cursor-pointer hover:text-blue-400" onClick={handleViewDetails}>
          {product.name}
        </h3>
        ...
        <div className="mt-auto">
          <button
            ...
            className="w-full px-4 py-2 bg-yellow-400 text-gray-900 font-bold rounded-md shadow-md hover:bg-yellow-300 transform hover:scale-105 transition-all duration-300"
          >
            Add to Cart
          </button>
        </div>
